...
export const QUEUES: Queues[] = [
  ...
  { id: 71, name: 'NYJC_ENABLE_CASE_TRANSFER_ACCESS', divisionId: 6 },
  ...
  { id: 81, name: 'QUEUE_OGC_CLOSE', divisionId: 8 },
  { id: 81, name: 'QUEUE_OGC_CONSULT', divisionId: 8 },
  { id: 81, name: 'QUEUE_OGC_PROC', divisionId: 8 },
  { id: 81, name: 'QUEUE_OGC_REVIEW', divisionId: 8 },
  { id: 81, name: 'NYJC_A&N_DEATH_CASE_DRILLDOWN_ACCESS', divisionId: 9 },
  { id: 81, name: 'NYJC_ADJ_CASE_DRILLDOWN_ACCESS', divisionId: 9 },
  { id: 81, name: 'NYJC_PROS_CASE_DRILLDOWN_ACCESS', divisionId: 9 },
  { id: 81, name: 'NYJC_A&N_DEATH_CASE_DRILLDOWN_ACCESS', divisionId: 10 },
  { id: 81, name: 'NYJC_ADJ_CASE_DRILLDOWN_ACCESS', divisionId: 10 },
  { id: 81, name: 'NYJC_INITIATE_ADJ_PROS_ACCESS', divisionId: 10 },
  { id: 81, name: 'NYJC_PROS_CASE_DRILLDOWN_ACCESS', divisionId: 10 },
  { id: 81, name: 'QUEUE_DENOVO_REVIEW', divisionId: 10 },
  { id: 81, name: 'QUEUE_SPIG', divisionId: 10 },
  { id: 81, name: 'NYJC_A&N_DEATH_CASE_DRILLDOWN_ACCESS', divisionId: 11 },
  { id: 81, name: 'NYJC_ADJ_CASE_DRILLDOWN_ACCESS', divisionId: 11 },
  { id: 81, name: 'NYJC_PROS_CASE_DRILLDOWN_ACCESS', divisionId: 11 },
  { id: 81, name: 'QUEUE_ADJUDICATION', divisionId: 11 },
  { id: 81, name: 'NYJC_SEL_ALERT', divisionId: 11 },
  { id: 81, name: 'QUEUE_CHANGE_SEL', divisionId: 11 },
  { id: 81, name: 'QUEUE_MERGE_REQUEST', divisionId: 11 },
  { id: 81, name: 'NYJC_A&N_DEATH_CASE_DRILLDOWN_ACCESS', divisionId: 12 },
  { id: 81, name: 'NYJC_ADJ_CASE_DRILLDOWN_ACCESS', divisionId: 12 },
  { id: 81, name: 'NYJC_INITIATE_ADJ_PROS_ACCESS', divisionId: 12 },
  { id: 81, name: 'NYJC_PROS_CASE_DRILLDOWN_ACCESS', divisionId: 12 },
  { id: 81, name: 'QUEUE_DENOVO_REVIEW', divisionId: 12 },
  { id: 81, name: 'QUEUE_SPIG', divisionId: 12 },
  { id: 81, name: 'NYJC_A&N_DEATH_CASE_DRILLDOWN_ACCESS', divisionId: 13 },
  { id: 81, name: 'NYJC_A&N_DEATH_CASE_DRILLDOWN_ACCESS', divisionId: 14 },
  { id: 81, name: 'QUEUE_OSP', divisionId: 14 },
  { id: 81, name: 'NYJC_A&N_DEATH_CASE_DRILLDOWN_ACCESS', divisionId: 16 },
  { id: 81, name: 'NYJC_ADJ_CASE_DRILLDOWN_ACCESS', divisionId: 16 },
  { id: 81, name: 'NYJC_IFSU_OMBUDS_GO_TO_CASE_ACCESS', divisionId: 16 },
  { id: 81, name: 'NYJC_PROS_CASE_DRILLDOWN_ACCESS', divisionId: 16 },
  { id: 81, name: 'QUEUE_IFSU', divisionId: 16 },
  { id: 81, name: 'NYJC_A&N_DEATH_CASE_DRILLDOWN_ACCESS', divisionId: 17 },
  { id: 81, name: 'NYJC_FORENSICS_ACCESS', divisionId: 17 },
  { id: 81, name: 'QUEUE_PQI', divisionId: 18 },
  { id: 81, name: 'QUEUE_PQI_AGING', divisionId: 18 },
  { id: 81, name: 'QUEUE_PQI_AUDIT', divisionId: 18 },
  { id: 81, name: 'QUEUE_PQI_AUDIT_OPWDD', divisionId: 18 },
  { id: 81, name: 'QUEUE_PQI_HOLD', divisionId: 18 },
  { id: 81, name: 'QUEUE_PQI_SUP', divisionId: 18 },
  { id: 81, name: 'QUEUE_PQI_SUP_REVIEW', divisionId: 18 },
  { id: 81, name: 'NYJC_A&N_DEATH_CASE_DRILLDOWN_ACCESS', divisionId: 18 },
  { id: 81, name: 'NYJC_ADJ_CASE_DRILLDOWN_ACCESS', divisionId: 18 },
  { id: 81, name: 'NYJC_CAP_ACTIVITY_CSN_ISN_DRILLDOWN_ACCESS', divisionId: 18 },
  { id: 81, name: 'AA_JC_QUEUE', divisionId: 18 },
  { id: 81, name: 'NYJC_A&N_DEATH_CASE_DRILLDOWN_ACCESS', divisionId: 19 },
  { id: 81, name: 'NYJC_ADD_SEALED_ACCESS_ACTIVITY', divisionId: 19 },
  { id: 81, name: 'NYJC_CAP_ACTIVITY_CSN_ISN_DRILLDOWN_ACCESS', divisionId: 19 },
];
